...
import numpy as np
import cv2
img_to_detect = cv2.imread('Images/5jpg.jpg')
print((img_to_detect))
...
"""
scale factoe is 0.00392 = 1/255 since 255 is the maximum pixel value of any color in an image.
...
class_colors = ["0,255,0","255,0,0","255,255,0","0,0,255","0,255,255"]
...
#____________________________________________NMS_CHANGE_3_END____________
    ...
    #convert the color numpy array into a list and apply to the text box
    ...
    cv2.putText(img_to_detect, predicted_class_label,(start_x_pt, start_y_pt-5), cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.5 , color = box_color)
